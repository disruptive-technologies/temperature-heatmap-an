...
rooms = [
    ...
    Room(
        ...
        sensors = [
            Sensor(x=30.6, y= 2.0, name='bjei50vbluqg00dltju0')
        ],
    ),
    ...
    Room(
        ...
        sensors = [
            Sensor(x=35.4, y= 3.0, name='bjei8rgpismg008hqdu0')
        ],
    ),
    ...
    Room(
        ...
        sensors = [
            Sensor(x=30.5, y= 8.4, name='bjei75vbluqg00dltkig')
        ],
    ),
]
...
doors = [
    ...
    Door(p1=[29.5, 4.0], p2=[30.5, 4.0], room1=rooms[1], room2=rooms[4]),
    Door(p1=[30.5, 4.0], p2=[31.5, 4.0], room1=rooms[1], room2=rooms[5]),
    Door(p1=[33.0, 6.0], p2=[33.0, 5.0], room1=rooms[1], room2=rooms[6]),
    Door(p1=[30.0, 6.0], p2=[31.0, 6.0], room1=rooms[1], room2=rooms[7]),
]
